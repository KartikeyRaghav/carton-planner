    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-6xl mx-auto px-6 pt-24 pb-16 text-center">
        ...
        <p className="text-xl text-surface-500 mb-10 max-w-2xl mx-auto leading-relaxed">
          Calculate exact sheet sizes for any carton style instantly.
          Built for packaging engineers, print buyers, and pre-press professionals.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/auth/signup" className="btn-primary text-base px-8 py-3.5 shadow-brand animate-pulse-glow">
            Start Free Trial
          </Link>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            <div key={i} className="card p-6">
              ...
              <h3 className="font-display font-700 text-lg text-surface-900 mb-2">{f.title}</h3>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        <div className="bg-brand-500 rounded-3xl p-12 text-center text-white">
          <h2 className="font-display text-4xl font-700 mb-4">Ready to plan smarter?</h2>
          <p className="text-brand-100 mb-8 text-lg">Start your free 1-day trial — no credit card needed.</p>
