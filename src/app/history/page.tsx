                ...
                {sheetCalcs.map((calc, i) => {
                  ...
                  return (
                    <div key={calc.id} className="card overflow-hidden">
                      <button
                        className="w-full px-5 py-4 flex items-center justify-between hover:bg-surface-50 transition-colors text-left"
                        onClick={() =>
        ...
        {/* {isLoading ? (
          ...
          <div className="space-y-3 animate-in">
            {calculations.map((calc, i) => {
              ...
              const results = calc.results as unknown as SheetLayout[];
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-surface-400 mt-0.5 font-mono">
                          L:{calc.length} × W:{calc.width} × H:{calc.height}{" "}
                          {calc.unit}
                          &nbsp;· PF:{calc.pastingFlap} · TF:{calc.tuckInFlap} ·
                          LBM:{calc.lockBottomMargin}
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center gap-4 flex-shrink-0">
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-surface-400 mt-0.5">
                              {calc.inputs?.sheetQty} sheets ·{" "}
                              {calc.inputs?.unitsPerSheet} units/sheet · GSM{" "}
                              {calc.inputs?.gsm}
                            </p>
                          </div>
                        </div>
...
//     if (!isAuthenticated) return;
//     setSheetLoading(true);
//     fetch(`/api/calculations?page=${sheetPage}&limit=15`, {
//       credentials: "include",
//     })
//       .then((r) => r.json())
//       .then((data) => {
...
//                           <div>
//                             <p className="font-semibold text-surface-900 text-sm capitalize">
//                               {calc.packagingFormat} Packaging
//                               <span className="ml-2 text-xs text-surface-400 font-mono">
//                                 #{calc.id.slice(-6).toUpperCase()}
//                               </span>
//                             </p>
//                             <p className="text-xs text-surface-400 mt-0.5">
//                               {calc.inputs?.sheetQty} sheets ·{" "}
...
//                             <p className="text-xs text-surface-400">
//                               per{" "}
//                               {calc.packagingFormat === "bag" ? "bag" : "box"}:{" "}
//                               {fmt(calc.costPerUnit)}
//                             </p>
//                           </div>
//                           <div className="text-right hidden sm:block">
